...
//-------------细胞菜品设计-----Customize the appearance of table view cells.
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
		...
		UIButton *orderBtn = [[[UIButton buttonWithType:UIButtonTypeRoundedRect] retain] autorelease];
        orderBtn.frame = CGRectMake(220, 32, 50, 20);
        //orderBtn.tag = [indexPath row]+1;	//when row is 0,tag would be nil
        [orderBtn setTitle:@"点菜" forState:UIControlStateNormal];
        ...
        //        UIButton *collectBtn = [[[UIButton buttonWithType:UIButtonTypeRoundedRect] retain] autorelease];
        //        collectBtn.frame = CGRectMake(280, 2, 20, 57);
        //        collectBtn.tag = [indexPath row]+1;	//when row is 0,tag would be nil
