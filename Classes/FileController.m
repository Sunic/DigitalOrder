...
+(NSUInteger)addOneToRow:(NSUInteger)row {
	...
	NSMutableDictionary *listDict = [[NSMutableDictionary alloc] initWithDictionary:[self loadOrderList]];	
    //[NSMutableDictionary dictionaryWithContentsOfFile:[self fullpathOfFilename:kOrderListFile]];
	if(listDict == nil) 
